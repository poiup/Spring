...
public class UploadController {
	...
	@ResponseBody
	public ResponseEntity<List<BoardAttachVO>> uploadFormPost(MultipartFile[] uploadFile, Model model) {

		// BoardAttachVO는 파일 한개의 정보를 저장합니다
		// 현재 파일 업로드는 여러 파일을 동시에 업로드하므로 List<BoardAttachVO>를 받도록 처리합니다.
